...
package dev.kommunicate.devkit.api.attachment;
...
//            }
        ...
        if (downloaderTask != null) {
            ...
            synchronized (sInstance) {
                ...
                if (null != thread) {
                    ...
                    dev.kommunicate.devkit.api.conversation.Message message = documentView ? downloaderTask.getAttachmentView().getMessage() : downloaderTask.getPhotoView().getMessage();
    ...
    static public AttachmentTask startDownload(
            ...
            boolean cacheFlag, dev.kommunicate.devkit.api.conversation.Message message, MediaDownloadProgressHandler handler, Context context) {
