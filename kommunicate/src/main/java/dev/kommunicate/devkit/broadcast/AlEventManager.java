package dev.kommunicate.devkit.broadcast;
...
import dev.kommunicate.devkit.listners.AlMqttListener;
import dev.kommunicate.devkit.listners.ApplozicUIListener;
import dev.kommunicate.devkit.listners.KmConversationInfoListener;
import dev.kommunicate.devkit.listners.KmStatusListener;
...
public class AlEventManager {
    ...
    public void sendOnConversationResolvedEvent(dev.kommunicate.devkit.api.conversation.Message message) {
    ...
    public void sendOnMessageSent(dev.kommunicate.devkit.api.conversation.Message message) {
        if (kmPluginEventListener != null) {
            kmPluginEventListener.onMessageSent(message);
        }
    }

    public void sendOnMessageReceived(dev.kommunicate.devkit.api.conversation.Message message) {
        if (kmPluginEventListener != null) {
    ...
    public void sendOnNotificationClick(dev.kommunicate.devkit.api.conversation.Message message) {
        if (kmPluginEventListener != null) {
