...
public class AlEventManager {
    ...
    private Map<String, KommunicateUIListener> listenerMap;
    ...
    public void registerUIListener(String id, KommunicateUIListener listener) {
        if (listenerMap == null) {
    ...
    public void sendOnConversationResolvedEvent(io.kommunicate.data.conversation.Message message) {
    ...
    public void sendOnMessageSent(io.kommunicate.data.conversation.Message message) {
        if (kmPluginEventListener != null) {
            kmPluginEventListener.onMessageSent(message);
        }
    }

    public void sendOnMessageReceived(io.kommunicate.data.conversation.Message message) {
        if (kmPluginEventListener != null) {
    ...
    public void sendOnNotificationClick(io.kommunicate.data.conversation.Message message) {
        if (kmPluginEventListener != null) {
    ...
    private void handleState(Message message) {
        if (message != null) {
            ...
            if (listenerMap != null && !listenerMap.isEmpty()) {
                for (KommunicateUIListener listener : listenerMap.values()) {
                    switch (messageEvent.getAction()) {
                        case AlMessageEvent.ActionType.MESSAGE_SENT:
