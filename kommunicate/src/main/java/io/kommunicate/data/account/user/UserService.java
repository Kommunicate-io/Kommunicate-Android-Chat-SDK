...
import io.kommunicate.notification.MuteUserResponse;
...
import io.kommunicate.models.feed.RegisteredUsersApiResponse;
import io.kommunicate.models.feed.SyncBlockUserApiResponse;
import io.kommunicate.models.feed.sync.SyncUserBlockFeed;
import io.kommunicate.models.feed.sync.SyncUserBlockListFeed;
...
public class UserService {
    ...
    public static UserService getInstance(Context context) {
        if (userService == null) {
            userService = new UserService(KommunicateService.getContext(context));
        }
        return userService;
    }
    ...
    public synchronized void processUser(UserDetail userDetail) {
        processUser(userDetail, Contact.ContactType.KOMMUNICATE);
    }

    public synchronized Contact getContactFromUserDetail(UserDetail userDetail) {
        return getContactFromUserDetail(userDetail, Contact.ContactType.KOMMUNICATE);
    }
