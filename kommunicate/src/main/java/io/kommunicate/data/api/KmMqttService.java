...
import io.kommunicate.broadcast.AlMessageEvent;
...
import io.kommunicate.models.feed.GcmMessageResponse;
import io.kommunicate.models.feed.InstantMessageResponse;
 ...
 */
public class KmMqttService extends MobiComKitClientService implements MqttCallback {

    private static final String STATUS = "status-v2";
    private static final String TAG = "KmMqttService";
    ...
    private static KmMqttService kmMqttService;
    private AlMqttClient client;
    private MemoryPersistence memoryPersistence;
    private Context context;

    private KmMqttService(Context context) {
        super(context);
        this.context = context;
        memoryPersistence = new MemoryPersistence();
    }

    public static KmMqttService getInstance(Context context) {

        if (kmMqttService == null) {
            kmMqttService = new KmMqttService(context.getApplicationContext());
        }
        return kmMqttService;
    }
    ...
    private AlMqttClient connect() {
        ...
        try {
            ...
            if (!client.isConnected()) {
                ...
                client.setCallback(KmMqttService.this);
