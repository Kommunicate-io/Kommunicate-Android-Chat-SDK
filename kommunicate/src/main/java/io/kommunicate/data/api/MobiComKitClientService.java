package io.kommunicate.data.api;
...
public class MobiComKitClientService {
    ...
    public static final String BASE_URL_METADATA = "io.kommunicate.chat.server.url";
    public static final String KM_BASE_URL_METADATA = "io.kommunicate.server.url";
    public static final String MQTT_BASE_URL_METADATA = "io.kommunicate.mqtt.server.url";
    ...
    public static String APPLICATION_KEY_HEADER_VALUE_METADATA = "io.kommunicate.application.key";
    public static String APP_MODULE_NAME_META_DATA_KEY = "io.kommunicate.module.key";
    public static String FILE_BASE_URL_METADATA_KEY = "io.kommunicate.attachment.url";
    public static String FILE_UPLOAD_METADATA_KEY = "io.kommunicate.attachment.upload.endpoint";
    public static String FILE_DOWNLOAD_METADATA_KEY = "io.kommunicate.attachment.download.endpoint";
    protected Context context;
    protected String DEFAULT_URL = "https://chat.kommunicate.io";
    protected String FILE_BASE_URL = "https://chat.kommunicate.io";
    protected String DEFAULT_MQTT_URL = "tcp://socket.kommunicate.io:8080";
    ...
    public static String getApplicationKey(Context context) {
        String applicationKey = KmChat.getInstance(KommunicateService.getContext(context)).getApplicationKey();
        if (!TextUtils.isEmpty(applicationKey)) {
            return applicationKey;
        }
        return Utils.getMetaDataValue(KommunicateService.getContext(context), APPLICATION_KEY_HEADER_VALUE_METADATA);
    }

    public static String getAppModuleName(Context context) {
        return Utils.getMetaDataValue(KommunicateService.getContext(context), APP_MODULE_NAME_META_DATA_KEY);
    }
