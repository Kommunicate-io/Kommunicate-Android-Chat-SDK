...
public final class MobiComKitConstants {
    ...
    public static final String KOMMUNICATE_VIDEO_CALL_ANSWER = "kommunicate.video.call.answer";
    public static final String KOMMUNICATE_VIDEO_CALL_REJECTED = "kommunicate.video.call.rejected";
    public static final String KOMMUNICATE_VIDEO_DIALED = "kommunicate.video.call.dialed";
    public static final String PACKAGE_NAME = "com.package.name";
    public static final String AL_MESSAGE = "AL_MESSAGE";
    public static final String APPLICATION_KEY_META_DATA = "io.kommunicate.application.key";
    public static final String APPLICATION_ACTIVITY_TO_OPEN_ON_CHAT_TOOLBAR_TAP = "io.kommunicate.mobicomkit.uiwidgets.toolbar.tap.activity";
    public static final String APPLICATION_LOGIN_ACTIVITY = "io.kommunicate.loginActivity";
