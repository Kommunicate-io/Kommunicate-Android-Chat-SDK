...
//            }
                ...
                if (attachmentTask != null && attachmentTask.getMessage() != null && attachmentTask.getDownloadHandler() != null && inputMessage != null) {
                    switch (inputMessage.what) {
                        ...
                        case DOWNLOAD_FAILED:
                            ...
                            attachmentTask.getMessage().setAttDownloadInProgress(false);
                            attachmentTask.getDownloadHandler().onCompleted(null, new KommunicateException("Download failed"));
        ...
        if (downloaderTask != null) {
            ...
            synchronized (sInstance) {
                ...
                if (null != thread) {
                    ...
                    io.kommunicate.data.conversation.Message message = documentView ? downloaderTask.getAttachmentView().getMessage() : downloaderTask.getPhotoView().getMessage();
    ...
    static public AttachmentTask startDownload(
            ...
            boolean cacheFlag, io.kommunicate.data.conversation.Message message, MediaDownloadProgressHandler handler, Context context) {
