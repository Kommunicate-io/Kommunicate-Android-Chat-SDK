...
public abstract class BaseAsyncTask<Progress, Result> {
    ...
    } //call this in UI thread before call()
    ...
    } //call this in UI thread after call()

    protected void onProgress(Progress progress) {
    } //call this in the UI thread; make your own implementation for it

    protected void publishProgress(Progress progress) {
    } //add implementation to call onProgress in UI thread

    public abstract void execute(); //the code for execution of all the above listed functions

    protected void onCancelled() {
    } //this code will be run if task is cancelled
}
