package io.kommunicate.data.channel.database;
...
public class ChannelDatabaseService {
    ...
    private ChannelDatabaseService(Context context) {
        ...
        this.mobiComUserPreference = MobiComUserPreference.getInstance(KommunicateService.getContext(context));
        this.dbHelper = MobiComDatabaseHelper.getInstance(KommunicateService.getContext(context));
    }

    public synchronized static ChannelDatabaseService getInstance(Context context) {
        if (channelDatabaseService == null) {
            channelDatabaseService = new ChannelDatabaseService(KommunicateService.getContext(context));
        }
