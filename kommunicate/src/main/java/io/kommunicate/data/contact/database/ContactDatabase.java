package io.kommunicate.data.contact.database;
...
public class ContactDatabase {
    ...
    public ContactDatabase(Context context) {
        ...
        this.userPreferences = MobiComUserPreference.getInstance(KommunicateService.getContext(context));
            ...
            public Cursor loadInBackground() {
                ...
                if (parentGroupKey != null && parentGroupKey != 0) {
                    ...
                    if (userIdArray != null && userIdArray.length > 0) {
                        ...
                        String selection = "deletedAtTime=0";
                        List<String> selectionArgs = new ArrayList<>();
                        if (KommunicateClient.getInstance(context).isShowMyContacts()) {
                            if (!TextUtils.isEmpty(searchString)) {
