...
import io.kommunicate.data.conversation.schedule.ScheduleMessageService;
...
public class MessageIntentService extends AlJobIntentService {
    ...
    static public void enqueueWork(Context context, Intent work, Handler handler) {
        enqueueWork(KommunicateService.getContext(context), MessageIntentService.class, JOB_ID, work);
        if (work != null) {
