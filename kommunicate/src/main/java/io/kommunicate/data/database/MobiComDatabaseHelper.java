...
public class MobiComDatabaseHelper extends SQLiteOpenHelper {
    ...
    private MobiComDatabaseHelper(Context context) {
        this(context, !TextUtils.isEmpty(ALSpecificSettings.getInstance(KommunicateService.getContext(context)).getDatabaseName()) ? ALSpecificSettings.getInstance(KommunicateService.getContext(context)).getDatabaseName() : "MCK_" + MobiComKitClientService.getApplicationKey(KommunicateService.getContext(context)), null, DB_VERSION);
    ...
    public static MobiComDatabaseHelper getInstance(Context context) {
        ...
        if (sInstance == null) {
            sInstance = new MobiComDatabaseHelper(KommunicateService.getContext(context));
        }
        return sInstance;
    }
