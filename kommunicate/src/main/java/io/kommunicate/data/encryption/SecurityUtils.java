package io.kommunicate.data.encryption;
    ...
    private static void generateRSAKeyPair(Context context) {
        try {
            ...
            keyPairGenerator.genKeyPair();
                 ...
                 NoSuchProviderException | SecurityException exception) {
    ...
    public static KeyPair getRSAKeyPair(Context context) {
        try {
            ...
            return new KeyPair(publicKey, privateKey);
                 ...
                 NoSuchAlgorithmException | IOException | UnrecoverableEntryException exception) {
            exception.printStackTrace();
