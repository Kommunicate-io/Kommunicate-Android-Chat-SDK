 ...
 * Do not touch settings from this file, unless asked to do so by KmChat
...
public class ALSpecificSettings {
    ...
    private static ALSpecificSettings KmSettings;
    private SharedPreferences sharedPreferences;

    private ALSpecificSettings(Context context) {
        this.sharedPreferences = KommunicateService.getContext(context).getSharedPreferences(MY_PREFERENCE, Context.MODE_PRIVATE);
    }

    public static ALSpecificSettings getInstance(Context context) {
        if (KmSettings == null) {
            KmSettings = new ALSpecificSettings(KommunicateService.getContext(context));
        }
        return KmSettings;
    }
    ...
    public String getSupportEmailId() {
        return sharedPreferences.getString(AL_SUPPORT_EMAIL_ID, "support@kmChat.com");
    }
