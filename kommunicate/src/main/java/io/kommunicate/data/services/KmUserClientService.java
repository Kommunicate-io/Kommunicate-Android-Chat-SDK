...
import io.kommunicate.data.encryption.EncryptionUtils;
import io.kommunicate.data.json.GsonUtils;
import io.kommunicate.data.people.contact.Contact;
import io.kommunicate.users.KMUser;
import io.kommunicate.exception.InvalidApplicationException;
import io.kommunicate.KmException;
import io.kommunicate.exception.UnAuthoriseException;
import io.kommunicate.models.KMGroupInfo;
import io.kommunicate.models.feed.KmRegistrationResponse;
import io.kommunicate.utils.Utils;

import static io.kommunicate.data.api.HttpRequestUtils.DEVICE_KEY_HEADER;
...
//            return null;
        ...
        KommunicateClient.getInstance(context).skipDeletedGroups(user.isSkipDeletedGroups());
