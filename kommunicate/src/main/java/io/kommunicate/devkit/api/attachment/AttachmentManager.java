...
//            }
        ...
        if (downloaderTask != null) {
            ...
            synchronized (sInstance) {
                ...
                if (null != thread) {
                    ...
                    io.kommunicate.devkit.api.conversation.Message message = documentView ? downloaderTask.getAttachmentView().getMessage() : downloaderTask.getPhotoView().getMessage();
    ...
    static public AttachmentTask startDownload(
            ...
            boolean cacheFlag, io.kommunicate.devkit.api.conversation.Message message, MediaDownloadProgressHandler handler, Context context) {
