...
public class VideoCallNotificationHelper {
    ...
    public static final String NOTIFICATION_ACTIVITY_NAME = "io.kommunicate.audiovideo.activity.CallActivity";
...
//    }
    ...
    public void handleVideoCallNotificationMessages(final Message message) {
        ...
        if (type.equals(CALL_DIALED)) {
            ...
            Intent intent = new Intent(MobiComKitConstants.KOMMUNICATE_VIDEO_CALL_ANSWER);
            intent.putExtra(CALL_ID, videoCallId);
            LocalBroadcastManager.getInstance(context).sendBroadcast(intent);

        } else if (type.equals(CALL_REJECTED)) {

            Intent intent = new Intent(MobiComKitConstants.KOMMUNICATE_VIDEO_CALL_REJECTED);
            intent.putExtra(CALL_ID, videoCallId);
            LocalBroadcastManager.getInstance(context).sendBroadcast(intent);
    ...
    private void handleIncomingVideoNotification(Message msg) {
        ...
        if (BroadcastService.videoCallAcitivityOpend) {
            ...
            Intent intent = new Intent(MobiComKitConstants.KOMMUNICATE_VIDEO_DIALED);
