...
class UserUpdateUseCase(
    ...
    companion object {
         ...
         * This method provides an easy way to handle success or failure using a provided [ResultCallback].
         *
         ...
         * @param callback Optional [ResultCallback] for handling success or failure callbacks.
