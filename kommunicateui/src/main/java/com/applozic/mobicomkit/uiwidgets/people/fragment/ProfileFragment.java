...
public class ProfileFragment extends Fragment {
    ...
    private ImageView statusEdit, displayNameEdit, contactEdit;
    ...
    private void createView(View view) {
        ...
        statusEdit.setOnClickListener(statusEditListener);
        displayNameEdit.setOnClickListener(displayNameEditListener);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (file == null || !file.exists()) {
                ...
                Bitmap bm = BitmapFactory.decodeResource(getActivity().getResources(), R.drawable.ic_account_circle_grey_600_24dp);
    ...
    private View.OnClickListener statusEditListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    private View.OnClickListener displayNameEditListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
    ...
    private View.OnClickListener contactEditListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
