...
public abstract class KmRichMessage {
    ...
    private String getActionType(io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel model, io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmButtonModel buttonModel) {
        if (buttonModel != null) {
    ...
    protected void setActionListener(View view, final io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel model, final io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmButtonModel buttonModel, final io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmPayloadModel payloadModel) {
