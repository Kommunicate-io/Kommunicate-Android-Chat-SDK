...
import io.kommunicate.ui.conversation.richmessaging.models.KmBookingDetailsModel;
import io.kommunicate.ui.conversation.richmessaging.models.KmGuestCountModel;
import io.kommunicate.ui.conversation.richmessaging.models.KmHotelBookingModel;
...
public class RichMessageActionProcessor implements KmRichMessageListener {
    ...
    public void onAction(Context context, String action, Message message, Object object, Map<String, Object> replyMetadata) {
        ...
        switch (action) {
            ...
            case KmRichMessage.TEMPLATE_ID + 9:
                loadImageOnFullScreen(context, action, (io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmPayloadModel) object);
                break;
    ...
    public void handleWebLinks(Object object) {
        io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmAction kmAction = null;

        if (object instanceof io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmButtonModel) {
            kmAction = ((io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmButtonModel) object).getAction();
        } else if (object instanceof io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmElementModel) {
            kmAction = ((io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmElementModel) object).getAction();
        } else if (object instanceof io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmAction) {
            kmAction = (io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmAction) object;
        } else if (object instanceof io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmPayloadModel) {
            kmAction = ((io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmPayloadModel) object).getAction();
        }
        ...
        if (object instanceof io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmPayloadModel) {
            io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmPayloadModel payloadModel = (io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmPayloadModel) object;
    ...
    public void handleQuickReplies(Object object, Map<String, Object> replyMetadata) {
        ...
        if (object instanceof io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmPayloadModel) {
        ...
        } else if (object instanceof io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmButtonModel) {
            io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmButtonModel buttonModel = (io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmButtonModel) object;
            ...
            io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmAction action = (io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmAction) object;
            ...
            io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmElementModel elementModel = (io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmElementModel) object;
    ...
    public boolean isValidAction(io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmAction action) {
    ...
    public void handleSubmitButton(Context context, Object object) {
        if (object instanceof KmRMActionModel.SubmitButton) {
        ...
        } else if (object instanceof io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel) {
            io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel model = (io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel) object;
               try {
                   Map<String, String> localeMetadata = new HashMap<>();
                   localeMetadata.put(null,null);
                   ...
                   if (!model.getFormAction().isEmpty()) {
                       new KmPostDataAsyncTask(context,
                               model.getFormAction(),
                               null,
                               ((io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel) object).getRequestType(),
                               model.getFormData(),
                               new KmCallback() {
                                   @Override
                                   public void onSuccess(Object messageString) {
            ...
            makeFormRequest(context, (io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmPayloadModel) object);
        }
    }
    ...
    public void makeFormRequest(final Context context, io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmPayloadModel payloadModel) {
        if (payloadModel != null && payloadModel.getAction() != null) {
            ...
            new KmPostDataAsyncTask(context,
                    ...
                    GsonUtils.getJsonFromObject(payloadModel.getFormData(), io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmFormDataModel.class),
                    new KmCallback() {
                        @Override
    ...
    public void loadImageOnFullScreen(Context context, String action, io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmPayloadModel payloadModel) {
        Intent intent = new Intent(context, FullScreenImageActivity.class);
        intent.putExtra(action, GsonUtils.getJsonFromObject(payloadModel, io.kommunicate.ui.conversation.richmessaging.models.KmRichMessageModel.KmPayloadModel.class));
