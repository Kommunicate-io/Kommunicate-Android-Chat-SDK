...
public class KommunicateSetting {
    ...
    public static KommunicateSetting getInstance(Context context) {
        if (kommunicateSetting == null) {
            kommunicateSetting = new KommunicateSetting(KommunicateService.getContext(context));
        }
    ...
    public int getColor(String key) {
        return sharedPreferences.getInt(key, R.color.kommunicate_theme_color_primary);
    }

    public int getSentMessageBackgroundColor() {
        return sharedPreferences.getInt(SENT_MESSAGE_BACKGROUND_COLOR, R.color.kommunicate_theme_color_primary);
    }
    ...
    public int getSentMessageBorderColor() {
        return sharedPreferences.getInt(SENT_MESSAGE_BORDER_COLOR, R.color.kommunicate_theme_color_primary);
    }
    ...
    public int getAttachmentIconsBackgroundColor() {
        return sharedPreferences.getInt(ATTACHMENT_ICONS_BACKGROUND_COLOR, R.color.kommunicate_theme_color_primary);
    }
    ...
    public int getReceivedMessageLinkTextColor() {
        return sharedPreferences.getInt(RECEIVED_MESSAGE_LINK_TEXT_COLOR, R.color.kommunicate_green_color);
    }
    ...
    public int getSendButtonBackgroundColor() {
        return sharedPreferences.getInt(SEND_BUTTON_BACKGROUND_COLOR, R.color.kommunicate_theme_color_primary);
    }
    ...
    public int getConversationDateTextColor() {
        return sharedPreferences.getInt(CONVERSATION_DATE_TEXT_COLOR, R.color.kommunicate_gray_color);
    }
    ...
    public int getConversationDayTextColor() {
        return sharedPreferences.getInt(CONVERSATION_DAY_TEXT_COLOR, R.color.kommunicate_gray_color);
    }
    ...
    public int getChannelCustomMesssageTextColor() {
        return sharedPreferences.getInt(CHANNEL_CUSTOM_MESSAGE_TEXT_COLOR, R.color.kommunicate_lite_gray_color);
    }
    ...
    public int getChannelCustomMesssageBgColor() {
        return sharedPreferences.getInt(CHANNEL_CUSTOM_MESSAGE_BG_COLOR, R.color.kommunicate_custom_channel_message_text_color);
    }
    ...
    public int getChannelCustomMesssageBorderColor() {
        return sharedPreferences.getInt(CHANNEL_CUSTOM_MESSAGE_BORDER_COLOR, R.color.kommunicate_custom_channel_message_text_color);
    }
