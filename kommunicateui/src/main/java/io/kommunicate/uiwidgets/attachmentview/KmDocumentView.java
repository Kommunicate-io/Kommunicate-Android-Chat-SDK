package io.kommunicate.uiwidgets.attachmentview;
...
import io.kommunicate.data.api.attachment.AttachmentTask;
import io.kommunicate.data.api.attachment.AttachmentViewProperties;
...
public class KmDocumentView {
    ...
    public void inflateViewWithMessage(View rootview, Message message) {
        ...
        downloadInProgressLayout = (RelativeLayout) rootview.findViewById(R.id.kommunicate_doc_download_progress_rl);
        downloadedLayout = (RelativeLayout) rootview.findViewById(R.id.kommunicate_doc_downloaded);
        ...
        progressBar = (ProgressBar) rootview.findViewById(R.id.kommunicate_doc_download_progress);
        sizeTextView = (TextView) rootview.findViewById(R.id.kommunicate_doc_file_size);
        fileText = (TextView) rootview.findViewById(R.id.kommunicate_doc_file_name);
        uploadDownloadImage = (ImageView) rootview.findViewById(R.id.kommunicate_download_image);
        ...
        audioseekbar = (SeekBar) rootview.findViewById(R.id.kommunicate_audio_seekbar);
        ...
        progressBar.getIndeterminateDrawable().setColorFilter(message.isTypeOutbox() ? context.getResources().getColor(R.color.kommunicate_green_color) : context.getResources().getColor(R.color.black), android.graphics.PorterDuff.Mode.MULTIPLY);
    ...
    public void updateKommunicateSeekBar() {
