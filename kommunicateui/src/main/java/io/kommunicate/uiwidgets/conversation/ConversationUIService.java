...
import io.kommunicate.uiwidgets.async.KmChannelDeleteTask;
import io.kommunicate.uiwidgets.async.KmChannelLeaveMember;
import io.kommunicate.uiwidgets.conversation.activity.ConversationActivity;
import io.kommunicate.uiwidgets.conversation.activity.MobiComAttachmentSelectorActivity;
...
import io.kommunicate.uiwidgets.conversation.fragment.MessageInfoFragment;
...
import io.kommunicate.uiwidgets.uilistener.KmFragmentGetter;
    ...
    public void channelLeaveProcess(final Channel channel) {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(fragmentActivity).
                setPositiveButton(R.string.channel_exit, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        KmChannelLeaveMember.ChannelLeaveMemberListener kmLeaveMemberListener = new KmChannelLeaveMember.ChannelLeaveMemberListener() {
                            @Override
                        ...
                        KmChannelLeaveMember kmChannelLeaveMember = new KmChannelLeaveMember(fragmentActivity, channel.getKey(), MobiComUserPreference.getInstance(fragmentActivity).getUserId(), kmLeaveMemberListener);
