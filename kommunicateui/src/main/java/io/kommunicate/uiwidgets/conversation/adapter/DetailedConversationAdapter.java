package io.kommunicate.uiwidgets.conversation.adapter;
...
import io.kommunicate.data.api.attachment.AttachmentManager;
...
import io.kommunicate.notification.VideoCallNotificationHelper;
...
import io.kommunicate.uiwidgets.attachmentview.KmDocumentView;
...
import io.kommunicate.uiwidgets.conversation.activity.FullScreenImageActivity;
import io.kommunicate.uiwidgets.conversation.activity.MobiComKitActivityInterface;
import io.kommunicate.uiwidgets.conversation.activity.OnClickReplyInterface;
import io.kommunicate.uiwidgets.conversation.fragment.FeedbackInputFragment;
...
import io.kommunicate.utils.EmoticonUtils;
...
public class DetailedConversationAdapter extends RecyclerView.Adapter implements Filterable {
    ...
    public DetailedConversationAdapter(final Context context, int textViewResourceId, List<Message> messageList, final Contact contact, Channel channel, Class messageIntentClass, EmojiconHandler emojiconHandler) {
        ...
        geoApiKey = KmChat.getInstance(context).getGeoApiKey();
                ...
                if (message.getMetadata() != null) {
                    ...
                    switch (ratingValue) {
                        case FeedbackInputFragment.RATING_POOR:
                            myViewholder6.imageViewFeedbackRating.setImageDrawable(ContextCompat.getDrawable(context, io.kommunicate.uiwidgets.R.drawable.ic_sad_1));
                            break;
                        case FeedbackInputFragment.RATING_AVERAGE:
                            myViewholder6.imageViewFeedbackRating.setImageDrawable(ContextCompat.getDrawable(context, io.kommunicate.uiwidgets.R.drawable.ic_confused));
                            break;
                        case FeedbackInputFragment.RATING_GOOD:
                            myViewholder6.imageViewFeedbackRating.setImageDrawable(ContextCompat.getDrawable(context, io.kommunicate.uiwidgets.R.drawable.ic_happy));
                            break;
                        default:
                            myViewholder6.imageViewFeedbackRating.setImageDrawable(ContextCompat.getDrawable(context, io.kommunicate.uiwidgets.R.drawable.ic_confused));
    ...
    static class MyViewHolder3 extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder3(View itemView) {
            super(itemView);
            customContentTextView = (TextView) itemView.findViewById(R.id.kommunicate_custom_message_layout_content);
        }
    }
    ...
    static class MyViewHolder5 extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder5(View itemView) {
            super(itemView);
            statusTextView = (TextView) itemView.findViewById(R.id.kommunicate_call_status);
            timeTextView = (TextView) itemView.findViewById(R.id.kommunicate_call_timing);
            durationTextView = (TextView) itemView.findViewById(R.id.kommunicate_call_duration);
            imageView = (ImageView) itemView.findViewById(R.id.kommunicate_call_image_type);
        }
    }
