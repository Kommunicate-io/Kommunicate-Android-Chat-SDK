...
public class MessageInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        attachmentView = (AttachmentView) view.findViewById(R.id.kommunicate_message_info_attachmentview);
        ProgressBar progressBar = (ProgressBar) view.findViewById(R.id.kommunicate_message_info_progress_bar);
        attachmentView.setProressBar(progressBar);
        attachmentView.setVisibility(message.hasAttachment() ? View.VISIBLE : View.GONE);


        RelativeLayout defaultRelativeLayout = (RelativeLayout) view.findViewById(R.id.kommunicate_message_info_default_layout);
        TextView textView = (TextView) view.findViewById(R.id.kommunicate_message_info_message_text);
        readListView = (RecyclerView) view.findViewById(R.id.kommunicate_message_info_read_list);
        deliveredListView = (RecyclerView) view.findViewById(R.id.kommunicate_message_info_delivered_list_view);
    ...
    private void setupAttachmentView(Message message, RelativeLayout defaultRelativeLayout) {
        ...
        ImageView attachmentInconView = (ImageView) defaultRelativeLayout.findViewById(R.id.kommunicate_message_info_attachment_icon);
        TextView attachmentFilename = (TextView) defaultRelativeLayout.findViewById(R.id.kommunicate_message_info_attachment_filename);
