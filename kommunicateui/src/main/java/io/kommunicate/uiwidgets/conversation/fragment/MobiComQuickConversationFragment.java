...
import io.kommunicate.uiwidgets.DimensionsUtils;
...
import io.kommunicate.uiwidgets.conversation.adapter.QuickConversationAdapter;
...
public class MobiComQuickConversationFragment extends Fragment implements SearchListFragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (alCustomizationSettings.isProfileOption()) {
            menu.findItem(R.id.kommunicateUserProfile).setVisible(true);
        }
