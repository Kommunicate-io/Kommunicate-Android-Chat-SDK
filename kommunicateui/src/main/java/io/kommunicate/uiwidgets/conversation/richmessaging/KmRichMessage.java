...
public abstract class KmRichMessage {
    ...
    protected io.kommunicate.uiwidgets.conversation.richmessaging.models.v2.KmRichMessageModel kmRichMessageModel;
    ...
    public KmRichMessage(Context context, LinearLayout containerView, Message message, KmRichMessageListener listener, AlCustomizationSettings alCustomizationSettings, boolean showTimestamp) {
        ...
        this.kmRichMessageModel = gson.fromJson(GsonUtils.getJsonFromObject(message.getMetadata(), Map.class), new TypeToken<io.kommunicate.uiwidgets.conversation.richmessaging.models.v2.KmRichMessageModel>() {
        }.getType());
