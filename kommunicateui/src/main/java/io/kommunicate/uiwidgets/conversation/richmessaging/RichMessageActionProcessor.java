package io.kommunicate.uiwidgets.conversation.richmessaging;
...
import io.kommunicate.uiwidgets.conversation.richmessaging.models.KmBookingDetailsModel;
import io.kommunicate.uiwidgets.conversation.richmessaging.models.KmGuestCountModel;
import io.kommunicate.uiwidgets.conversation.richmessaging.models.KmRichMessageModel;
import io.kommunicate.uiwidgets.conversation.richmessaging.models.KmHotelBookingModel;
import io.kommunicate.uiwidgets.conversation.richmessaging.models.KmFormStateModel;
import io.kommunicate.uiwidgets.conversation.richmessaging.models.v2.KmFormPayloadModel;
import io.kommunicate.uiwidgets.conversation.richmessaging.models.v2.KmRMActionModel;
...
public class RichMessageActionProcessor implements KmRichMessageListener {
    ...
    private void sendFormDataAsMessage(Message message, Map<String, String> replyMetadata, Map<String, Object> formSelectedData, String submitButtonMessage) {
        if (message.getMetadata() != null) {
            io.kommunicate.uiwidgets.conversation.richmessaging.models.v2.KmRichMessageModel<List<KmFormPayloadModel>> richMessageModel = new Gson().fromJson(GsonUtils.getJsonFromObject(message.getMetadata(), Map.class), new TypeToken<io.kommunicate.uiwidgets.conversation.richmessaging.models.v2.KmRichMessageModel>() {
            }.getType());
