package io.kommunicate.uiwidgets.kommunicate.utils;
...
public class KmThemeHelper implements KmCallback {
    ...
    public int getPrimaryColor() {
        if (primaryColor == -1) {
            primaryColor = parseColorWithDefault(appSettingPreferences.getPrimaryColor(), context.getResources().getColor(R.color.kommunicate_theme_color_primary));
        }
        return primaryColor;
    }
    ...
    public int getSentMessageBackgroundColor() {
        if (sentMessageBackgroundColor == -1) {
            ...
            sentMessageBackgroundColor = parseColorWithDefault(colorStr, context.getResources().getColor(R.color.kommunicate_theme_color_primary));
        }
    ...
    public int getSentMessageBorderColor() {
        if (sentMessageBorderColor == -1) {
            ...
            sentMessageBorderColor = parseColorWithDefault(colorStr, context.getResources().getColor(R.color.kommunicate_theme_color_primary));
        }
    ...
    public int getSendButtonBackgroundColor() {
        if (sendButtonBackgroundColor == -1) {
            ...
            sendButtonBackgroundColor = parseColorWithDefault(colorStr, context.getResources().getColor(R.color.kommunicate_theme_color_primary));
        }
    ...
    public int getSecondaryColor() {
        if (secondaryColor == -1) {
            secondaryColor = parseColorWithDefault(appSettingPreferences.getSecondaryColor(), context.getResources().getColor(R.color.kommunicate_theme_color_primary_dark));
        }
